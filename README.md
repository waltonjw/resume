...
- Designed and implemented full suite of continuous integration workflows and DevOps automation. [Gradle, Groovy, Gulp, Jenkins, Docker, AWS CloudFormation, AWS CloudWatch]
...
- Designed and implemented a URL classification SDK and web services layer for enterprise application integration.  [Java, Perl 5, J2EE, EJB3, JAX-WS]
...
- Managed a 2000 node global RF fingerprinting network. [NetBSD, Netcool]
...
- Designed and delivered circuit-switched wireless data implementations for small business customers.
- 1994 Circle of Excellence award, 1995 Account Representative of the Year award.

## Education

*Geographic Information Systems (GIS) Specialization*, UC Davis, 2022, 5 Courses [ESRI ArcMap]
